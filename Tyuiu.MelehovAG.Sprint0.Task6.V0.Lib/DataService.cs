...
namespace Tyuiu.MelehovAG.Sprint0.Task6.V0.Lib
{
    public class DataService
    {
        ...
        //Пример циклической структуры (цикл с параметрами) while
        ...
        //Пример циклической структуры (цикл с параметрами) do while
